...
const challenges = [
  { number: "01", title: "Objetivo duplo sem métrica unificada", desc: "O laboratório precisava entregar um product concreto (o curta) e, simultaneamente, gerar um mapa de viabilidade para o COE. Sem North Star Metric formal, era preciso equilibrar velocidade de produção com profundidade de aprendizado." },
          ...
          <SectionReveal delay={0.2}>
            <div className="p-6 md:p-8 bg-white border border-[#E0E0E0]">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex gap-3 text-sm" style={{ color: "#666666" }}>
                  <span style={{ color: "#FF5722", flexShrink: 0 }}>•</span>
                  Framework de avaliação informou escolha de ferramentas para adoção, com economia documentada de R$5M+ (referência pública Mobile Time)
                </li>
                <li className="flex gap-3 text-sm" style={{ color: "#666666" }}>
                  <span style={{ color: "#FF5722", flexShrink: 0 }}>•</span>
