...
const PROFILE_PHOTO = "https://res.cloudinary.com/dnbgmiii1/image/upload/v1771688086/1770914698984_y1pqib.png";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-3">
            <SectionReveal delay={0.1}>
              <p className="text-base md:text-[17px] leading-relaxed mb-4" style={{ color: "#555555" }}>
                Meu trabalho segue uma lógica clara:
              </p>
              <p className="text-lg md:text-xl font-serif mb-4" style={{ color: "#333333", fontWeight: 700 }}>
                Estratégia &rarr; Discovery &rarr; Execução orientada a métricas.
              </p>
              <p className="text-base md:text-[17px] leading-relaxed mb-10" style={{ color: "#666666" }}>
...
/* ─── EXPERIENCE (vertical timeline with internal scroll) ─── */
