...
const CASE_IA_IMG = "https://private-us-east-1.manuscdn.com/sessionFile/Q4hh0nJv4MAaZJwGicPvcE/sandbox/KXF13z1u3M8PmHW22qtUyj-img-2_1771685385000_na1fn_Y2FzZS1pYS1oZXJv.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy= /format,webp/quality,q_80&Expires=1798761600&Policy=&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=I~FFvzWdGPdsde-lJwukD2PVXgqSpn8DtWQllfymTUbVWhCWEjhtIj8dkXk4gJFfvAe6Vt1hMvgSanvpNJlPS2uhZSvNBtoDxZn8wxEbr7GBwz91bh1dN5ozG3XCCI99p0b5my9rcwiw1Ch5z3YYcYldR8EiFDaDjPlpuxyOFavT1e~qVfHZmpg5XMQ1VGSt-yoIXwU1Rn8GAUgNFIj7~bAMUpGzhz4GWHYlcTZT~wizTjE4rcUQ3-27lVuC2BQj1Eib4x9a8TCGz8379cc0x~9RWrJwiB2EPEhSmGbieytbzsALTnUe0S516mBh48JThXAeg7ocD1uTOMPad9QjhQ__";
...
const ABSTRACT_1 = "https://private-us-east-1.manuscdn.com/sessionFile/Q4hh0nJv4MAaZJwGicPvcE/sandbox/KXF13z1u3M8PmHW22qtUyj-img-3_1771685367000_na1fn_YWJzdHJhY3QtcGF0dGVybi0x.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=_&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=uMOe63-uKhhH87WYCi71ExnhvfbDadWNsQywB1vjjEOYRz8a6oAENRx30hmcRbI1yCTpnQ~Y7ZvcKZOqngNBOBNtvi4uSMV~iHpYv4VAMaoEZTvbIe~oQ8oqZzCwsmf1pU8glkyDJkPUU5-hAMVEGwLQUvy2QQFzzVO2hpBT6IRTO3vlZAkrJ6QiwOl8LnTjaWWkEX~Obnz3Lz7sw3LNl4waGi~SXUajLG2kXPiXFGnLMu69SO3CiJ3feg3doq2sDK3MN7EZhss65Vco1fi62Ziky0b7wW1TMVj66U5MTm04k2kQMHCS1w0MzIC12SZU1V-2mNuGkPh3qaOh6nplOA__";
...
const experiences = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Aumentei coerência entre experiênca de produto e objetivos de negócio",
    ],
  },
];
      ...
      <div className="container relative z-10 pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="max-w-4xl lg:pr-[29rem] xl:pr-[40rem]">
          ...
          <motion.div
            ...
            className="flex flex-col gap-y-2 mb-10 max-w-2xl"
          >
            {[
              "+10 anos em digital",
              ...
              <div key={i} className="flex items-center gap-3">
                <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: "#E0E0E0" }} />
                <span className="text-[15px] leading-relaxed" style={{ color: "#666666" }}>
                  {item}
                </span>
              </div>
            ))}
            ...
            <SectionReveal delay={0.3}>
              <div className="p-6 md:p-8" style={{ backgroundColor: "#F0F0F0" }}>
                ...
                <ul className="space-y-4 mb-8">
                  {[
                    { title: "CSPO (Certified Product Owner)", org: "Scrum Alliance", date: "Fev/2026" },
                    { title: "A-CSPO (Advanced Product Owner)", org: "Scrum Alliance", date: "Mar/2026" },
                    { title: "AI Product Owner", org: "Especialização", date: "2024" },
                    { title: "MBA Gestão Estratégica", org: "USP", date: "2022" },
                  ].map((cert, i) => (
                    <li key={i} className="border-l pl-4" style={{ borderColor: "#E0E0E0" }}>
                      <p className="text-[14px] font-bold mb-0.5" style={{ color: "#333333" }}>{cert.title}</p>
                      <p className="text-[12px]" style={{ color: "#666666" }}>{cert.org} &bull; {cert.date}</p>
                    </li>
                  ))}
                </ul>
